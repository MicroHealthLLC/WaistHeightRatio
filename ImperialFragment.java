 ...
 */
// Edited by ANU Uprety, edited code follows by initials AU
public class ImperialFragment extends Fragment {
    ...
    Button calc;
    TextView error;
    // AU: used as field variables for entire class scope
    double waist_inches_value;
    double height_inches_value;
    // This can be omitted to be local variables
    /*double waist_value;
    double height_value;*/
...
// AU: This tests for both scenarios, and the if else statements test for singular scenarios, this helps run all scenarios
                while (waist_inch_text.getText().toString().isEmpty() && height_inch_text.getText().toString().isEmpty() ) {
                ...
                if(height_inch_text.getText().toString().isEmpty()){
                    ...
                    height_inches_value = Double.parseDouble(waist_inch_text.getText().toString());
                ...
                if(waist_inch_text.getText().toString().isEmpty()){
                    ...
                    waist_inches_value  =  Double.parseDouble(height_inch_text.getText().toString());
                }

                // AU: variable better suited for local scope
                double waist_value = (12* Double.parseDouble(waistft_text.getText().toString() )) +waist_inches_value;
                 double height_value = (12 *Double.parseDouble(heightft_text.getText().toString())) +height_inches_value;
                //  AU: Check bounds and puts readable easy user interface
                if (height_value > 260 || height_value <= 0 ||waist_value >1000 || waist_value<=0) {
                    error.setVisibility(View.VISIBLE);
                    error.setText("check your proportions");
                } else {
