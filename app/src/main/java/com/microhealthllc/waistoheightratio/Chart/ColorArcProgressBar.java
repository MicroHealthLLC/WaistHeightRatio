package com.microhealthllc.waistoheightratio.Chart;
...
public class ColorArcProgressBar extends View{
    ...
    int opaqueRed=Color.RED;
    int opaqueYellow = Color.YELLOW;
    int OpaqueGreen =Color.GREEN;
    int OpaqueOrange =Color.parseColor("#FF4500");
    int color1;
    int color2;
    int color3;
    int color4;
     ...
     * @param attrs
     */
    public void initCofig(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColorArcProgressBar);
        int colora = a.getColor(R.styleable.ColorArcProgressBar_front_color1, Color.GREEN);
        int colorb = a.getColor(R.styleable.ColorArcProgressBar_front_color2, color1);
        int colorc = a.getColor(R.styleable.ColorArcProgressBar_front_color3, color1);
        colors = new int[]{colora, colorb, colorc, colorc};
     ...
     * @param c
     */
    public void setCurrentValues(double c) {
        float currentValues = (float)c;
