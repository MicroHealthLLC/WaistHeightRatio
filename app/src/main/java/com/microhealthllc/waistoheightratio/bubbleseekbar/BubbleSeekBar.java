package com.microhealthllc.waistoheightratio.bubbleseekbar;
...
import com.microhealthllc.waistoheightratio.R;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
import java.math.BigDecimal;

import static com.microhealthllc.waistoheightratio.bubbleseekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.microhealthllc.waistoheightratio.bubbleseekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.microhealthllc.waistoheightratio.bubbleseekbar.BubbleSeekBar.TextPosition.SIDES;
import static com.microhealthllc.waistoheightratio.bubbleseekbar.BubbleUtils.dp2px;
import static com.microhealthllc.waistoheightratio.bubbleseekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.custom_theme_primary));
        ///note
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.custom_theme_dark));
